		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD JSH BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] Frz? Este é um recurso especial para o Frz ❌',
					ownerB: '[❗] Frz? Este é um recurso especial para o Frz ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de Frz. Registre-se para fazer amizade com o bot Jsh por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Causs|17\n\n──「 CAUSS BOT 」──`,
			...
			const ownerNumber = ["5532984114083@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5532984114083@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5532984114083@s@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5532984114083@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5532984114083@s.whatsapp.net","558296156440@s.whatsapp.net"] 
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS JSH BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @Frz domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o Frz ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT FRZ ✨* 」\n*│+ wa.me/5547992091566*╰──────*「 *FRZ* 」*────*\n\n*_SE QUER SER ADMIN DO BOT JSH_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/554792091566/*╰──────*「 * FRZ* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO JSH BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
